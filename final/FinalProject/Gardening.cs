...
class Gardening
{
    public List<Gardening> products;
    ...
    public void AddProduct()
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(NameInput))
            {
                ...
                {
                    Products products = new Gardening(NameInput, PriceInput);
...
public class Products
{
    ...
    public Products(string products, string NameInput, int priceInput)
    {
        this.products = products;
    }

    public Products(string NameInput, int priceInput)
    {

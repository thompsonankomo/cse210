...
class Precision
{
    public List<Precision> products;
    ...
    public Precision(string products, int priceInput) : this(products)
    {
    }
    ...
    public virtual void PrintAll()
    {
        ...
        else
        {
            ...
            {
                Console.WriteLine(i + 1 + ". " + Precision[i].returnDetails());
            }
    ...
    public void AddProduct()
    {
        ...
        try
        {
            ...
            if (!string.IsNullOrEmpty(NameInput))
            {
                ...
                {
                    Products products = new Precision(NameInput, PriceInput);
...
public class Precision
{
    ...
    public Precision(string products, string NameInput, int priceInput)
    {
    ...
    public Precision(string products)
    {
    }

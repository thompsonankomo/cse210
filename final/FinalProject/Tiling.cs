...
class Tiling
{
    ...
    public Tiling(string name, int PriceInput)
    {
        this.name= name;
    }

    public Tiling(string v)
    {
        this.v = v;
    }
    ...
    {
        Console.WriteLine("Welcome to Asakhe Tiling");
...
public class Tiling
{
    ...
    public Tiling(string products, string NameInput, int priceInput)
    {
        this.products= products;
    }

    public Tiling(string NameInput, int priceInput)
    {
        this.NameInput = NameInput;
        this.PriceInput = PriceInput;
    }

    public Tiling(string Tiling)
    {
    }
